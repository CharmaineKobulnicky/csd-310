...
def show_players(cursor, title):
    ...
    for player in players:
        print(" Player ID: {}\n First Name: {}\n Team Name: {}\n".format(player[1], player[2], player[3], player[4], player[5], player[6], player[7]))

    
try:
    """ try/catch block for handling potential MySQL database errors """

    db = mysql.connector(**config) # connect to the pysports database
    ...
    update_player = ("UPDATE player SET team_id = 3, first_name = 'Grace', last_name = 'Yu' WHERE first_name = 'Dino'")
    ...
    # delete query
    delete_player = ("DELETE FROM player WHERE first_name = 'Grace'")
